...
const TermsAndConditionsScreen: React.FC<TermsAndConditionsScreenProps> = ({ onNavigate }) => {
  return (
    <div className="bg-background min-h-screen">
      ...
      <div className="p-5 max-w-2xl mx-auto space-y-5 pb-12">
        <p className="text-xs text-text-secondary text-right">Effective: 2026-03-07</p>

        <p className="text-text-secondary leading-relaxed">
          These terms and conditions apply to the Homefarm app (hereby referred to as "Application") for mobile devices that was created by (hereby referred to as "Service Provider") as a Free service.
        </p>
        <p className="text-text-secondary leading-relaxed">
        ...
        <div>
          <h2 className="text-base font-bold text-text-primary mb-2">Changes to These Terms and Conditions</h2>
          <p className="text-text-secondary leading-relaxed">
        ...
        <div>
          <h2 className="text-base font-bold text-text-primary mb-2">Contact Us</h2>
          <p className="text-text-secondary leading-relaxed">
