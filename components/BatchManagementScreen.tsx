...
interface BatchFormProps {
    onSave: (batchData: Omit<Batch, 'id'>, batchId?: number) => void;
    onClose: () => void;
...
const BatchForm: React.FC<BatchFormProps> = ({ onSave, onClose, batchToEdit, selectedFarm, activeSector }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black/50 z-30 flex items-center justify-center p-4" onClick={onClose}>
            <div className="bg-popover rounded-2xl shadow-lg w-full max-w-md max-h-[90vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
                <div className="p-6">
