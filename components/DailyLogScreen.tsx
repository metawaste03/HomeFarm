    ...
    return (
        <div className="bg-background min-h-screen">
            <div className="relative">
                <header className="bg-card p-4 shadow-md z-10 lg:hidden">
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                            {eggCategories.map(category => (
                                <button
                                    ...
                                    className={`px-4 py-2 text-sm font-semibold rounded-full transition-colors duration-200 ${activeCategories.has(category)
